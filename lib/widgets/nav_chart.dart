...
const Color ProfitColor=Colors.green;
const Color LossColor=Colors.red;
...
List<NavEntry> get  filtered{
  ...
  final res= all.where((e)=>e.date.isAfter(cutoff)|| e.date.isAtSameMomentAs(cutoff)).toList();
          ...
          child: Padding(
            ...
            child: LineChart(
              LineChartData(
                ...
                lineBarsData: [
                  LineChartBarData(spots: spots, isCurved: true, dotData: const FlDotData(show: false), color: LineColor, barWidth: 1.5),
                ],
                gridData: FlGridData(
                  show: true,
                  ),
